...
struct znedi3_filter2::data {
	graphengine::Graph graph;
	node_id src_node = graphengine::null_node;
	node_id dst_node = graphengine::null_node;
};

znedi3_filter2::znedi3_filter2(const NNEDI3Weights &weights, const znedi3_filter_params &params, unsigned width, unsigned height)
{
...
znedi3_filter2::~znedi3_filter2() = default;

std::unique_ptr<znedi3_filter2::filters> znedi3_filter2::setup_filters(const NNEDI3Weights &weights, const znedi3_filter_params &params, unsigned width, unsigned height)
{
...
std::unique_ptr<znedi3_filter2::data> znedi3_filter2::setup_graph(const NNEDI3Weights &weights, const znedi3_filter_params &params, unsigned width, unsigned height, bool parity)
{
...
size_t znedi3_filter2::get_tmp_size() const
{
	return std::max(m_data_t->graph.get_tmp_size(), m_data_b->graph.get_tmp_size());
}

void znedi3_filter2::process(const void *src, ptrdiff_t src_stride, void *dst, ptrdiff_t dst_stride, void *tmp, bool parity) const
{
